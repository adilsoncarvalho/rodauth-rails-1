...
<% end -%>
    ...
    #   t.references :account, foreign_key: true, null: false<%= primary_key_type %>
...
<% end -%>
    ...
    #   t.references :account, foreign_key: true<%= primary_key_type %>
    #   t.string :password_hash, null: false
    # end

    # # Used by the lockout feature
    # create_table :account_login_failures<%= primary_key_type %> do |t|
    #   t.foreign_key :accounts, column: :id<%= primary_key_type %>
    ...
    #   t.column :id<%= primary_key_type || ", type: :integer" %>
    #   t.foreign_key :accounts, column: :id
    #   t.string :code
    # end
